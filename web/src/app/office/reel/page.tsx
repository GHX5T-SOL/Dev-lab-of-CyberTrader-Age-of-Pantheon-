...
const REELS: Reel[] = [
  {
    ...
    accent: "#00F5FF",
    blurb:
      "A 40-second cold-open. Glitch title, a pan across the Neon Void skyline, the roster of 16 operators, and the five stations on the floor.",
    beats: [
  ...
  },
  {
    ...
    accent: "#7A5BFF",
    blurb:
      "How twelve AI operators run alongside Ghost, Zoro, Zara, and Zyra. Quorum ring, the workflow diagram, and the three non-negotiables that keep the pace honest.",
    beats: [
  ...
  },
  {
    ...
    beats: [
      ...
      "00:23 — signoff: built by Ghost + Zoro + 12 AI operators + 2 OpenClaw agents",
    ],
  },
];
