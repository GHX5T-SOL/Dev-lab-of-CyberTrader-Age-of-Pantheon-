...
export const STATUS: StatusBlock = {
  ...
  recentWins: [
    ...
    "Oracle shipped terminal pressure flow in v6 1631381: bound AgentOS factions now apply deterministic 8-tick pressure windows and /terminal shows compact pressure-window plus limit-trigger previews",
