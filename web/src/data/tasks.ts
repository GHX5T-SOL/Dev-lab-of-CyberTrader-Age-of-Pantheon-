...
export const TASKS: Task[] = [
  ...
  task({
    ...
    notes:
      "Ship-loop pass 2026-04-29T07:35Z: v6 head 5902d1d is green after live shell readiness hardening; ship:check passed with safety scan, typecheck, 188/188 Jest tests, and Expo web export; qa:axiom:live passed 1/1; prior 89d1f9a qa:axiom passed 11/11 after rebuilt web export. Full native iOS/Android QA remains blocked on a host with full Xcode/simctl plus Android adb/emulator.",
    links: [
