...
export const ROADMAP: Phase[] = [
  ...
  },
  {
    ...
    deliverables: [
      ...
      "Operator Brief retention patch on home and terminal with first-profit progress, Heat ladder, and one next action",
      ...
      "Commodity, faction, and OS presentation direction typed for all launch commodities, launch AgentOS factions, and PirateOS/AgentOS/PantheonOS hierarchy",
      ...
      "Local ship check, retention beta/tuning checks, explicit autonomous safety range scan, focused terminal-pressure/limit-order/route-pressure/inventory-bay/authority/operator-brief/presentation-direction checks, player smoke, clean-cache export, local Axiom QA, responsive QA, provenance check, SDK 54 package check, live Vercel smoke, post-push monitor, AgentOS regression, store-media provenance, perf budgets, AgentOS contract-chain checks, live shell readiness hardening, profile route assertion stabilization, and intro smoke pass on verified v6 origin/main c6f6f07",
    ...
    milestones: [
      ...
      { label: "Operator Brief retention patch", done: true },
      ...
      { label: "Commodity/faction/OS presentation direction", done: true },
