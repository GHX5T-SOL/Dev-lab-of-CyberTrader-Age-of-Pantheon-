...
export const ROADMAP: Phase[] = [
  ...
  },
  {
    ...
    deliverables: [
      ...
      "Local ship check, local Axiom QA, provenance check, clean-cache export, SDK 54 package check, live Vercel smoke, post-push monitor, AgentOS regression, store-media provenance, and perf budgets pass on verified v6 origin/main 7bf5e38",
