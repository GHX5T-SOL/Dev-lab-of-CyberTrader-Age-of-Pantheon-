...
export const ROADMAP: Phase[] = [
  {
    ...
    status: "active",
    summary: "Scaffold the Dev Lab. Lock the stack. Get a working virtual office up.",
    deliverables: [
      "Dev Lab repo live on GitHub (done)",
      "12-agent AI team roster + personas (done)",
      "AI Council charter + prompt guidelines (done)",
      "Dev Lab website Phase A deployed (in progress)",
    ...
    milestones: [
      ...
      { label: "Dev Lab web scaffold deployed to Vercel", done: false },
