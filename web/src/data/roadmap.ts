...
export const ROADMAP: Phase[] = [
  ...
  },
  {
    ...
    deliverables: [
      ...
      "Local ship check, retention beta/tuning checks, explicit autonomous safety range scan, focused terminal-pressure/limit-order/route-pressure/inventory-bay checks, player smoke, clean-cache export, local Axiom QA, responsive QA, provenance check, SDK 54 package check, live Vercel smoke, post-push monitor, AgentOS regression, store-media provenance, perf budgets, AgentOS contract-chain checks, and intro smoke pass on verified v6 origin/main 7d92e7f",
