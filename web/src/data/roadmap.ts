...
export const ROADMAP: Phase[] = [
  ...
  },
  {
    ...
    deliverables: [
      ...
      "Deterministic limit-order and faction-pressure engine contracts plus terminal pressure-window and limit-trigger previews for bound AgentOS factions",
      ...
      "Local ship check, focused terminal-pressure/limit-order checks, player smoke, clean-cache export, local Axiom QA, provenance check, SDK 54 package check, live Vercel smoke, post-push monitor, AgentOS regression, store-media provenance, perf budgets, AgentOS contract-chain checks, and intro smoke pass on verified v6 origin/main 1631381",
