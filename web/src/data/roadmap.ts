...
export const ROADMAP: Phase[] = [
  {
    ...
    status: "active",
    summary:
      "Scaffold the Dev Lab. Lock the stack. Get the virtual office live, then arm Zyra and Zara for autonomous OpenClaw work.",
    deliverables: [
      "Dev Lab repo live on GitHub (done)",
      "12-subagent AI Council roster + personas (done)",
      "Zyra + Zara OpenClaw workers configured for Mac mini autonomy (done)",
      "AI Council charter + prompt guidelines (done)",
      "Dev Lab website Phase A deployed to Vercel (done)",
    ...
    milestones: [
      ...
      { label: "Zyra + Zara OpenClaw cron loops armed", done: true },
      { label: "First AI Council session held on live question", done: false },
    ],
    owners: ["Ghost", "Zoro", "Compass", "Cipher", "Zyra", "Zara"],
  },
  {
    id: "phase-1",
    name: "Phase 1 — MVP",
    ...
    deliverables: [
      ...
      "Zyra daily QA + Zara implementation loops producing reviewable PRs",
    ],
    milestones: [
    ...
    owners: ["Ghost", "Zoro", "Rune", "Kite", "Oracle", "Vex", "Zyra", "Zara"],
  },
  {
    id: "phase-2",
