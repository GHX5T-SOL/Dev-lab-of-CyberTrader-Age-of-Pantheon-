...
export const ROADMAP: Phase[] = [
  ...
  },
  {
    ...
    deliverables: [
      ...
      "Deterministic limit-order and faction-pressure engine contracts for future terminal command wiring",
      ...
      "Local ship check, local Axiom QA, provenance check, clean-cache export, SDK 54 package check, live Vercel smoke, post-push monitor, AgentOS regression, store-media provenance, perf budgets, AgentOS contract-chain checks, limit-order checks, and intro smoke pass on verified v6 origin/main 3ab5746",
