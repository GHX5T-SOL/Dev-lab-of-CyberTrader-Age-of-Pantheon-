...
export const ROADMAP: Phase[] = [
  ...
  },
  {
    ...
    deliverables: [
      ...
      "Deterministic limit-order and faction-pressure engine contracts plus terminal pressure-window previews and persisted LocalAuthority limit-order commands",
