...
export const ROADMAP: Phase[] = [
  ...
  },
  {
    ...
    deliverables: [
      ...
      "Market swarm simulation plan with five NPC archetypes, reproducible inputs, and reports feeding Oracle and Nyx tuning",
    ...
    milestones: [
      ...
      { label: "Hydra market swarm simulation plan", done: true },
