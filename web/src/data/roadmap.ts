...
export const ROADMAP: Phase[] = [
  ...
  },
  {
    ...
    deliverables: [
      ...
      "Store-facing asset audit, Dev Lab provenance report, and zara-p1-005 generated provenance workflow with resolution, ownership, hashes, dimensions, clearance, and icon/splash findings",
