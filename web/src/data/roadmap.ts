...
export const ROADMAP: Phase[] = [
  ...
  },
  {
    ...
    deliverables: [
      ...
      "Local AgentOS ship check, local Axiom QA, provenance check, clean-cache export, SDK 54 package check, live Vercel smoke, post-push monitor, and AgentOS regression pass on verified v6 origin/main 7c9b47c",
      "Zoro store media approval, screenshot capture, provenance check, safety scan, typecheck, and Expo web export pass on verified v6 origin/main 65ad6ce",
