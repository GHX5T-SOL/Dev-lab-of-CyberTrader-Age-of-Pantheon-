...
export const ROADMAP: Phase[] = [
  ...
  },
  {
    ...
    status: "active",
    summary:
      "The first playable slice is now live locally, so Phase 1 is focused on hardening it into a repeatable demo across web, Android, and iOS.",
    deliverables: [
      "Zoro-approved creative brief for the first playable slice (done)",
      "BIOS boot screen -> Terminal Home transition (done)",
      "Deterministic tick loop beyond PRNG helpers (done)",
      "Authority Adapter: LocalAuthority complete; SupabaseAuthority stub (done)",
      "First trade flow end-to-end (buy / sell / ledger write) (done)",
