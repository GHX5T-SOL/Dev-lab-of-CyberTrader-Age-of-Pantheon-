...
- v6 GitHub repo is public, default branch `main`, latest implementation head is `5481191` (`zyra-p1-004`, pushed `2026-04-28`), after the 2026-04-28 Zara/Zyra maintenance commits.
...
- Current checks previously recorded: `npm run health:live`, `npm run qa:axiom:live`, `npm run ship:check`, `npm run build:web -- --clear`, `npm run typecheck`, `npm test -- --runInBand`, `npx expo export --platform web`, `npm run qa:responsive`, plus browser smoke for intro/login/trading.
