...
- v6 GitHub repo is public, default branch `main`, latest head is `ff7b7c3` (`axiom-p1-004`, pushed `2026-04-28`), after `daa33e9` hardened Axiom assertions, `98f1623` added the player smoke route, `d5a0a83` widened live-smoke readiness, `rune-p1-005` crash/log capture hooks in `9c0559e`, and `palette-p1-003` screenshot capture work in `2d1d03c`/`02ea079`.
