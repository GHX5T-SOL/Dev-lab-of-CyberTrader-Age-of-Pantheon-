...
- v6 GitHub repo is public, default branch `main`, latest implementation head is `48737cc` (`talon-p0-002`, pushed `2026-04-26`); parent `884e4b1` completed `zyra-p0-002` responsive QA self-containment.
