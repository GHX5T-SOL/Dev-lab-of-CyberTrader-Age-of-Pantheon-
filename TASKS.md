...
- v6 GitHub repo is public, default branch `main`, latest implementation head from this automation run is `c659817` (`ghost-p0-001`, pushed `2026-04-26`).
...
1. **Ghost** - release authority bar is complete; next Ghost work is architecture risk audit and first TestFlight/Play build-plan approval.
