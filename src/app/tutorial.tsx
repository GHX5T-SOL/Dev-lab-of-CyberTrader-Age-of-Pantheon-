...
const STEPS = [
  ...
  "0BOL IS YOUR TRADING CURRENCY. YOU START WITH 2,000 AND 40/200 XP TO PACKET RAT.",
  "THE FIRST HOUR IS SCRIPTED LIKE A RUN: KITE PINGS, A PROFIT WINDOW OPENS, THEN eAGENTS FORCE A CHOICE.",
