    ...
    <Modal visible={visible} transparent animationType="fade">
      <View style={{ flex: 1, backgroundColor: terminalColors.modalBackdrop, alignItems: "center", justifyContent: "center", padding: 22 }}>
        <View style={{ width: "100%", maxWidth: 360, borderWidth: 1, borderColor: terminalColors.red, backgroundColor: terminalColors.panel, padding: 16 }}>
          <Text style={{ fontFamily: terminalFont, color: terminalColors.red, fontSize: 14 }}>
            BLACK MARKET HEIST
          </Text>
          ...
          <Text style={{ marginTop: 12, fontFamily: terminalFont, color: terminalColors.text, fontSize: 11 }}>
          ...
          <View style={{ flexDirection: "row", gap: 8, marginTop: 12 }}>
            {HEIST_COLLATERAL_OPTIONS.map((option) => (
              ...
              >
                <Text style={{ fontFamily: terminalFont, color: selectedCollateral === option ? terminalColors.red : terminalColors.muted, textAlign: "center", fontSize: 11 }}>
                  {option}%
                </Text>
              </Pressable>
            ))}
          ...
          {draftMission ? (
            <View style={{ marginTop: 12 }}>
              ...
              <Text style={{ marginTop: 4, fontFamily: terminalFont, color: terminalColors.text, fontSize: 10 }}>
          ...
          <Pressable onPress={onClose} style={{ marginTop: 12, alignItems: "center" }}>
            <Text style={{ fontFamily: terminalFont, color: terminalColors.muted, fontSize: 12 }}>[ CANCEL ]</Text>
          </Pressable>
        </View>
      </View>
    </Modal>
