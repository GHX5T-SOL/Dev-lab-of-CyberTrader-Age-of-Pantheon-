...
Updated: 2026-04-29 (full autonomy directive active; v6 d165625 AgentOS faction selection, Axiom QA hardening, and provenance sync green)
...
- **AgentOS rank-5 unlock**: faction selection is live; next expand faction missions, route map, reputation consequences, faction rewards, limit orders, and stronger NPC contracts.
...
- v6 commit `d165625` is the latest verified head after AgentOS faction selection, local Axiom QA hardening, and provenance sync; `ship:check`, clean-cache web export, local Axiom QA, provenance check, live health, live Axiom smoke, and post-push regression monitor passed.
