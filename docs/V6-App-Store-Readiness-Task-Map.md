...
Updated: 2026-04-29 (full autonomy directive active; v6 7bf5e38 AgentOS faction selection, store-media approval, Axiom QA hardening, and provenance sync green)
...
- v6 commit `7bf5e38` is the latest verified head after AgentOS faction selection, store-media direction approval, local Axiom QA hardening, and provenance sync; `ship:check`, clean-cache web export, local Axiom QA, provenance check, live health, live Axiom smoke, and post-push regression monitor passed.
