...
Updated: 2026-04-29 (full autonomy directive active; v6 7bf5e38 Zoro store-media approval/provenance, AgentOS faction selection, SDK 54 package graph, GLCH archetype admission, worktree-safe regression, and perf budgets green)
...
- v6 commit `7bf5e38` is the latest verified head after AgentOS faction selection, Zoro store-media direction approval, Axiom QA hardening, and provenance refresh; validation includes `ship:check`, clean-cache web export, local Axiom QA, screenshot capture, provenance check, live health, live Axiom smoke, post-push regression monitor, and `perf:budgets`, with force `regression:check` verified on the AgentOS hardening commit `7c9b47c`.
