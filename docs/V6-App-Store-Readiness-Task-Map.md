...
Updated: 2026-04-29 (full autonomy directive active; v6 7c9b47c AgentOS faction selection and regression check green)
...
- v6 commit `7c9b47c` is the latest verified head after AgentOS faction selection and Axiom login-storage hardening; `ship:check`, `qa:axiom`, `perf:budgets`, cleared web export, provenance check, live health, and force `regression:check` passed.
