...
2. **AgentOS** - rank-5 faction choice, one-free-switch allegiance, mission bias, reputation hooks, mission contract chains, deterministic limit-order/faction-pressure engine interfaces, terminal pressure-window previews, and persisted terminal limit-order commands are live; next grow route-map consequences and deeper mission pressure hooks.
