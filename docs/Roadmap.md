...
- Store-facing asset audit, Dev Lab provenance report, and `zara-p1-005` generated provenance workflow exist with resolution, ownership, icon/splash, capture-safety, hash, dimension, clearance, and review-boundary findings.
...
- Zoro/Palette sign-off on icon/splash, generated provenance evidence, and approved screenshot-safe visual states.
- App preview video.
...
- Hydra market-swarm outputs remain available as beta economy regression fixtures.
