...
2. **AgentOS** - rank-5 faction selection is live; next grow faction missions, route-map consequences, reputation, limit orders, and stronger NPC contracts.
